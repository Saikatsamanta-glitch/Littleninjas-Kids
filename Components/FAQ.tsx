...
const FAQ = () => {
  ...
  return (
    <div className='w-full h-full mx-auto md:p-10 my-10'>
      <div className='w-full h-full flex justify-center items-center md:p-10  mx-auto '>
       <div className='w-full md:w-[70%] h-full md:p-10  flex flex-col items-center justify-start gap-y-10 md:gap-y-20'>
