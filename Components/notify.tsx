        ...
        return (<>
                {
                        ...
                        show ? <div className="sticky top-0 h-16 w-screen bg-[#FF847E] items-center flex justify-evenly overflow-hidden transition-all duration-300 "> < img src="/star.png" alt="" className="h-[90%]" />
