...
const HeroSection = () => {
        return (
                ...
                <div className='w-full flex-col-reverse md:flex-row bg-[#FBEDC9] h-auto md:pb-0 pb-10 rounded-b-[50px] flex md:justify-between md:items-center relative overflow-hidden'>
                        ...
                        <div className="pattern h-48 w-72 absolute top-9 -rotate-12 left-[40%] rounded-md bg-[#fff8e7]"></div>
                        <div className="pattern h-48 w-72 absolute top-5 -rotate-12 left-[50%] rounded-md bg-[#fcffd0]"></div>
...
{/* left column */}
                        <div className='md:pl-24 p-7 flex-1 relative flex flex-col md:h-full gap-y-7  justify-evenly pb-14'>
                                ...
                                <div className='flex items-center gap-x-7 '>
                                        <Button size="lg"  className='text-2xl  bg-[#FFE47E]  border-black/75 border-2 text-[rgb(84,84,84)] font-bold hover:bg-white'> 
                                        <img src="/calculator.png" alt="" className='h-4/6 me-3 '/> 
                                        <h2> Maths</h2>
                                        </Button>

                                        <Button size="lg" className='bg-white hover:bg-[#FFE47E] hover:text-black text-2xl font-bold outline-2  flex  text-[rgb(84,84,84)]'> 
...
{/* right column */}
                ...
                <img src="/level1blade.png" className='h-24 absolute md:left-24 md:-bottom-12 bottom:30 left-8 z-[80]'  alt="" />
